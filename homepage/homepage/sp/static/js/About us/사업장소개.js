...
//  본사, 안산 선택
    ...
    //본사
     $('#본사').click(function(){
        ...
        $('#안산').css('color','grey')
        $('#본사').css('color','black')
        $(".information_content_wrapper").html("");
        $(".information_content_wrapper").append("<ul><div class="+"line_info_01"+">주요업무</div><li>POWER DISCRETE ASSY & TEST</li><li>POWER MODULE ASSY & TEST</li><li>AUTOMOTIVE PRODUCT R&D</li><li>DSC MODULE PILOT PRODUCTION</li><li>SiC WAFER SAW + ASSY & TEST</li><li>WAFER SAW SERVICE – SiC , Si , Etc</li></ul>")
        $(".information_img_wrapper img").attr("src","/static/img/About%20us/%EC%82%AC%EC%97%85%EC%9E%A5%EC%86%8C%EA%B0%9C/%EB%B3%B8%EC%82%AC/%EB%B3%B8%EC%82%AC.jpg");
        $("#map_info").html("");
    ...
    $('#안산').click(function(){
        ...
        $('#안산').css('color','black')
        $(".information_content_wrapper").html("");
        $(".information_content_wrapper").append("<ul><div class="+"line_info_01"+">주요업무</div><li>POWER DISCRETE PLATING & TRIM</li><li>ALL MOLDED FRAME PLATING<br>IC, DISCRETE, MODULE</li><li>DSC MODULE PLATE (Ni + Sn)</li><li>SPECIAL PLATE (Ni, Sn , Cu)</li><li>CUSTOMIZING PLATE DEVELOP</li></ul>");
        $(".information_img_wrapper img").attr("src","/static/img/About%20us/%EC%82%AC%EC%97%85%EC%9E%A5%EC%86%8C%EA%B0%9C/%EC%95%88%EC%82%B0/%EC%95%88%EC%82%B0.jpg");
        $("#map_info").html("");
